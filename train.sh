...
# GaitGL
# CUDA_VISIBLE_DEVICES=5 python -m torch.distributed.launch --nproc_per_node=1 --master_port 12348 lib/main.py --cfgs ./config/gaitgl.yaml --phase train
# CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --master_port 12345 --nproc_per_node=4 lib/main.py --cfgs ./config/gaitgl.yaml --phase train
...
# GaitGL
#CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 lib/main.py --cfgs ./config/gaitgl_OUMVLP.yaml --phase train
